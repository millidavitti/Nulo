    ...
    <Container>
     <Grid className={home.heroGrid}>
      <div className={home.hero}>
       ...
       <Margin>
        <Description>
         Accompanying us, you have a trip full of experiences. With Nulo,
      ...
      <div className={home.whyUs}>
       ...
       <Margin>
        <div className={home.content}>
         ...
         <Description>
          We value our customers time. So, every interaction with our app brings
          you on step closer to booking a room at the hotel of your choice
         </Description>
        </div>
        <div className={home.content}>
         ...
         <Description>
          Millions of people are searching for unique places to stay around the
          world
         </Description>
        </div>
        <div className={home.content}>
     ...
     <ResponsiveGrid className={home.howItWorks}>
      <div>
       ...
       <Description textAlign="center">
        Let each trip b an inspirational journey, each room a peaceful space
       </Description>
      </div>
      <div>
       <SVGFrame size={200} margin="0 auto">
      ...
      <div>
       ...
       <SubHeadings textAlign="center">Have Fun & Make Memories</SubHeadings>
       <Description textAlign="center">
        Let each trip b an inspirational journey, each room a peaceful space
       </Description>
      </div>
